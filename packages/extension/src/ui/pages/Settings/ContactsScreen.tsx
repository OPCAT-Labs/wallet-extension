...
function SortableContactItem({ contact, index }: { contact: ContactBookItem; index: number }) {
  ...
  const chainInfo = CHAINS_MAP[contact.chain || ChainType.OPCAT_MAINNET];
...
export default function ContactsScreen() {
  ...
  const [selectedNetworkFilter, setSelectedNetworkFilter] = useState<ChainType>(ChainType.OPCAT_MAINNET);
              ...
              <Card style={{ backgroundColor: colors.black_muted, padding: spacing.medium }}>
                <Column gap="sm">
                  <Row itemsCenter gap="sm">
                    <Image src={CHAINS_MAP[selectedContact.chain || ChainType.OPCAT_MAINNET].icon} size={24} />
