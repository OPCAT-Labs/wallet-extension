...
const config = (env) => {
  ...
  const tailwindConfigPath = path.join(paths.appPath, 'tailwind.config.js');
  const useTailwind = fs.existsSync(tailwindConfigPath);
        ...
        options: {
          postcssOptions: {
            ...
            plugins: !useTailwind
              ...
              : [
                  require('tailwindcss')(path.join(paths.appPath, 'tailwind.config.js')),
                  'postcss-flexbugs-fixes',
                  ['postcss-preset-env', { autoprefixer: { flexbox: 'no-2009' }, stage: 3 }]
                ]
          },
    ...
    if (preProcessor) {
      ...
      if (preProcessor === 'less-loader') {
        preProcessorOptions = {
          ...
          lessOptions: {
            modifyVars: {
              'primary-color': '#01356e',
              'primary-color-active': '#012850',
              'input-icon-hover-color': '--color-text',
              'component-background': '#ffffff',
              'select-dropdown-bg': '#f1f5f9',
              'select-item-selected-bg': '#e2e8f0',
              'select-item-active-bg': '#e2e8f0',
              ...
              'layout-header-background': '#f1f5f9',
    ...
    module: {
      rules: [
        ...
        shouldUseSourceMap && {
          ...
          test: /\.(js|mjs|jsx|cjs|ts|tsx|css)$/,
